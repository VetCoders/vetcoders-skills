...
# vc-marbles — Blind Stabilization Round

<details>
<summary>Foundation Dependencies (Loaded with framework)</summary>

- [vc-loctree](../foundations/vc-loctree/SKILL.md) — structural map and hot-path locator.
- [vc-aicx](../foundations/vc-aicx/SKILL.md) — current-run steerability only.
