...
| `vc-justdo`    | Autonomous end-to-end implementation with followup and marbles built in.        | `vibecrafted justdo <agent>`                                                    | Yes     | Yes         | [SKILL](../skills/vc-justdo/SKILL.md) · [FLOW](../skills/vc-justdo/FLOW.md)       |
