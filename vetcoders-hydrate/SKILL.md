...
# vetcoders-hydrate — The Antidote to Always-in-Production
...
- After a `vetcoders-dou` audit identifies packaging gaps
...
- Writing marketing copy without understanding the product (run vetcoders-init first)
